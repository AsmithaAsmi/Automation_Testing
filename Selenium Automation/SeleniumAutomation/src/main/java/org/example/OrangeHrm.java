...
public class OrangeHrm {
    ...
    @FindBy(xpath = "//a/span[normalize-space()='Dashboard']")
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        orangeHrm.loginToOrangeHrm(readFromPropertyFile("UserName"), readFromPropertyFile("Password"));
//        orangeHrm.quitDriver();
    }
